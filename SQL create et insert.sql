...
insert into FILM values (1, 'Salut les copines', 'Valerie Damidot', 'Valerie Damidot', 0, 'Drame', 'tout publique', true);
insert into FILM values (2, 'Disparition au Habbo Hotel', 'Michel Houellebecq', 'Sean Connery', 0, 'Polar', '+12', true);
insert into FILM values (3, 'Renaissance Park', 'Quentin Tarantino', 'Lena Situations', 0, 'Film historique', 'tout publique', true);
insert into FILM values (4, 'Douchebag', 'Emmanuel Micron', 'Karine Leclerc', 0, 'Dystopie', '+16' , true);
insert into FILM values (5, "La congolexicomatisation des especes endemiques de l'ile d'Ouessant", 'Commandant Cousteau', 'Habib Dunant', 0, 'Reportage', 'tout publique', true);
insert into FILM values (6, 'Douche froide sous les tropiques', 'Ange Doume', 'Quentin Tarantino', 0, 'Drame', '+12', true);
insert into FILM values (7, 'Renaissance Park 2', 'Quentine Tarantino', 'Lena Situations', 0, 'Film historique', 'tout publique', true);
insert into FILM values (8, 'Dormir dans la soupe', 'Louis de Funes', 'Dany Brillant', 0, 'Comedie', 'tout publique', true);
insert into FILM values (9, "Soulager les douleurs hemorroidaires grace a l'injection de jus de concombre", 'Michel Cymes', 'Valerie Damidot', 0, 'Reportage', '+18', true);
insert into FILM values (10, 'Lent et tout mims avec du miel et des tricycles', 'Le Caillou', 'Sylvain Vilebrequin', 0, 'Course automobile', 'tout publique', true);

insert into SUPPORT values (1, true, 6);
insert into SUPPORT values (2, true, 7);
insert into SUPPORT values (3, false, 7);
insert into SUPPORT values (4, true, 9);
insert into SUPPORT values (5, true, 3);
insert into SUPPORT values (6, true, 10);
insert into SUPPORT values (7, false, 5);
insert into SUPPORT values (8, false, 1);
insert into SUPPORT values (9, false, 1);
insert into SUPPORT values (10, false, 2);
